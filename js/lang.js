...
lang.addEventListener("click", () => {
  if (thai) {
    ...
    round2.textContent = "รอบที่ 2";
    round22.textContent = "รอบที่ 2.2";
    round3.textContent = "รอบที่ 3";
    ...
    round2.textContent = "ROUND 2";
    round22.textContent = "ROUND 2.2";
    round3.textContent = "ROUND 3";
